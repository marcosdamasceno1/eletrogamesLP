...
export default function WhatsAppButton() {
  return (
    <a
      ...
      data-magnetic="0.22"
      className="group fixed bottom-5 right-5 z-40 flex h-14 min-h-[56px] w-14 items-center justify-center rounded-full bg-blue text-paper shadow-lift transition-colors hover:bg-blue-deep sm:w-auto sm:gap-2.5 sm:px-5"
    >
